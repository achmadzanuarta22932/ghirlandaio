...
```
mount --mkdir -o rw,nodev,nosuid,noexec,relatime /dev/proc/vtmp /mnt/var/audit
```
...
```
mount --mkdir -o rw,nosuid,noexec,relatime /dev/proc/vaud /mnt/var/log/tmp
```
...
```
echo "meteor ALL=(ALL:ALL) ALL" >  /etc/sudoers.d/none
```
